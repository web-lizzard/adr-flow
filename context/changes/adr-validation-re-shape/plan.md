...
- [ ] 2.1 Service tests for static phase, parallel calls, per-call retry, and failure raising
- [ ] 2.2 Fake LLM tests updated for section-scoped responses
- [ ] 2.3 `cd backend && uv run pytest tests/application/services/test_adr_review_service.py tests/infrastructure/llm/test_fake_completion.py -q`
