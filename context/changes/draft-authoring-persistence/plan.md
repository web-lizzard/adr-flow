...
- [x] 3.1 All new files pass ruff check and ruff format — d67ef4c
- [x] 3.2 Type checking passes: ty check — d67ef4c
- [x] 3.3 All tests pass: pytest (existing + new integration tests) — d67ef4c
- [x] 3.4 ADR integration tests verify create → update → reload cycle — d67ef4c

#### Manual

- [x] 3.5 curl POST /api/adrs with title returns 201 with id — d67ef4c
- [x] 3.6 curl POST /api/adrs with same title returns 409 — d67ef4c
- [x] 3.7 curl GET /api/adrs/{id} returns starter template content — d67ef4c
- [x] 3.8 curl GET /api/adrs/search?q=partial returns matching results — d67ef4c
- [x] 3.9 curl PATCH /api/adrs/{id} updates content, GET confirms — d67ef4c
